...
app.use("/messenger", passport.authenticate("jwt", {session: false}), messenger_router);

const conversation_router = require("./routes/secure/conversation");
app.use("/conversation", passport.authenticate("jwt", {session: false}), conversation_router);
